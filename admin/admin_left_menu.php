...
<div class="div_father menu">
	<div class="div_title"><?=$cplang['menu_big_area_forums']?></div>
	<div class="div_content">
		<?=menuitem('menu_area_forums','area_forums','area_forums')?>
	</div>
</div>
<div class="div_father menu">
	<div class="div_title"><?=$cplang['menu_big_user']?></div>
	<div class="div_content">
		<?=menuitem('menu_usergroup','user','usergroup')?>
		<?=menuitem('menu_admingroup','user','admingroup')?>
		<?=menuitem('menu_extcredits','user','extcredits')?>
		<?=menuitem('menu_user_add','user','user_add')?>
		<?=menuitem('menu_user_manager','user','user_manager')?>
	</div>
</div>
<div class="div_father menu">
